...
const OrdersDashboard = () => {
    ...
    const DeleteModal = () => {
        ...
        const orderDetails = orders.find(order => order.order_id === orderToDelete);
            ...
            <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50">
                <div className="bg-white rounded-lg shadow-lg max-w-md w-full p-6">
                    ...
                    <p className="text-gray-600 mb-4">
                        Are you sure you want to delete order <span className="font-medium">{orderToDelete}</span>?
                        {orderDetails && (
                            <span className="block mt-2 text-sm">
                                Product: {orderDetails.product_id} •
                                Customer: {orderDetails.number} •
        ...
        <div className="flex flex-col w-full max-w-6xl mx-auto p-6 bg-white rounded-lg shadow">
            ...
            <div className="flex justify-between items-center mb-8">
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <div className="relative">
                        <div className="flex items-center space-x-1 border border-gray-300 rounded-lg px-3 py-2 cursor-pointer" onClick={() => { }}>
                        ...
                        {filteredOrders.length > 0 ? (
                            filteredOrders.map((order: Order) => (
                                <tr key={order.order_id} className="hover:bg-gray-50">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm text-gray-900">{order.product_id}</div>
                                    </td>
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm text-gray-900">{formatDate(order.datetime)}</div>
                                    </td>
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm text-gray-900">{order.number}</div>
                                    </td>
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm text-gray-900">{order.quantity}</div>
                                    </td>
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm text-gray-900">${order.total_price}</div>
                                    </td>
                                    <td className="px-6 py-4 whitespace-nowrap">
                ...
                <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
                    <div className="flex items-center">
                        ...
                        <div>
                            ...
                            <p className="text-2xl font-semibold text-gray-900">
                                {orders.filter(order => order.order_status === 'out for delivery').length}
                            </p>
                        </div>
                    </div>
                </div>
